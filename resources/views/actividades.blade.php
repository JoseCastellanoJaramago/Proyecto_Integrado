...
@section('content')
{{--<div class="card" style="width: 18rem; display:inline-block; justify-content: center; align-items: center;">--}}
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Aerobic') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Fitness') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Agua') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Body Combat') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Pádel') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Pilates') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Zumba') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
    <div class="card" style="width: 18rem; display:inline-block">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('clases.Fisioterapia') }}" class="btn btn-primary">Más info</a>
        </div>
    </div>
{{--</div>--}}
