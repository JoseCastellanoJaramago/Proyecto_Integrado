...
<head>
    ...
    <title>@yield('title') - SafaGym</title>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    ...
                    <li class="nav-item active" style="margin-right: 10px">
                        ...
                        <a class="btn btn-primary" href="{{ route('clases.index') }}" >Actividades</a>
                    </li>
                    @endcan
                    @can('trainer.index')
                    <li style="margin-right: 10px">
                        <a class="btn btn-primary" href="{{ route('trainer.index') }}">Entrenadores</a>
                    </li>
                    @endcan
                    @can('admin.home')
                    <li style="margin-right: 10px">
